...
export default function AboutUs() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--panel-bg)', color: 'var(--text-primary)', minHeight: '100vh', padding: '20px', fontFamily: 'var(--font-sans)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px', borderBottom: '1px solid var(--border-color)', paddingBottom: '16px', position: 'sticky', top: 0, background: 'var(--panel-bg)', zIndex: 10 }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          <h2 style={{ color: 'var(--text-primary)', marginBottom: '16px', fontSize: '1.2rem', display: 'inline-block', borderBottom: '2px solid #2bd856', paddingBottom: '4px' }}>Special Thanks to Shiva</h2>
          <div style={{ background: 'rgba(128,128,128,0.10)', padding: '20px', borderRadius: '12px', borderLeft: '4px solid #00c6ff', boxShadow: '0 4px 15px rgba(0,0,0,0.2)' }}>
            <p style={{ margin: 0, color: 'var(--text-primary)', fontSize: '1.05rem', lineHeight: '1.7' }}>
              A massive shoutout to our very 1st user, <strong style={{ color: 'var(--text-primary)' }}>Shiva</strong> (<em>@shivuvb</em>). 
              <br/><br/>
